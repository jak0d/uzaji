...
export function RedesignedDashboard({ 
  ...
  console.log('Rendering RedesignedDashboard with businessType:', propBusinessType);
  ...
  useEffect(() => {
    console.log('RedesignedDashboard mounted');
    return () => {
      console.log('RedesignedDashboard unmounted');
    };
  }, []);
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
            ...
            <div className="p-4 bg-green-50 dark:bg-green-900/20 rounded-lg border border-green-200 dark:border-green-800">
              ...
              <p className="text-green-800 dark:text-green-200 text-sm">
                Monitor your cash flow regularly. Record transactions as they happen for the most accurate picture.
              </p>
            </div>
            <div className="p-4 bg-purple-50 dark:bg-purple-900/20 rounded-lg border border-purple-200 dark:border-purple-800">
              <h4 className="font-medium text-purple-900 dark:text-purple-100 mb-2">Growth Planning</h4>
              <p className="text-purple-800 dark:text-purple-200 text-sm">
                Use your financial data to identify trends and plan for business growth opportunities.
              </p>
            </div>
          </div>
        )}
